export default function Http({cb}:{cb:()=>void}) {
    return (
        <div onClick={cb}  className="cursor-pointer rounded border-[1px] p-1 flex flex-col justify-center items-center">
            <div>
                <svg className="" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" id="http">
            ...
            <p className="text-slate-500 text-center text-[10px]">HTTP</p>
        </div>
    );
}
